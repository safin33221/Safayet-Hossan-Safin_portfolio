...
const Skills = () => {
    const skills = [
        html, css, tailwind, javascript, reactjs,firebase, nodejs, mongodb, git, figma
    ]
    return (
        <div className=''>
            <SectionTile heading="Skills & Technologies." subheading="My Expertise" />
            <div className=' my-10 flex flex-wrap items-center justify-center gap-5 mx-auto px-12'>
                {
